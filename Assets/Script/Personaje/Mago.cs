...
{
    public Mago() : base() { }
    public Mago(int vida, int ataque, string faccion) : base(vida, ataque, faccion) { }
    public Mago(int vida, int ataque, string faccion, int x, int y) : base(vida, ataque, faccion, x, y) { }
